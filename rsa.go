...
// If directoryKeys does not exist in the current directory, create the directory and generate rsa public and private keys for each node
func genRsaKeys() {
	if !isExist("./Keys") {
		fmt.Println("Detects that the public-private key directory has not yet been generated and is generating the public-private key ...")
